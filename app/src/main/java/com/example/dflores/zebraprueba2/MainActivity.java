package com.example.dflores.zebraprueba2;
...
public class MainActivity extends AppCompatActivity implements EMDKListener, DataListener, StatusListener, ScannerConnectionListener, OnCheckedChangeListener{
    ...
    private void inicializarUI() {
        ...
        et_codScaneado = (EditText) findViewById(R.id.et_codScaneado);
